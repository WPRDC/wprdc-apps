...
export default async function Page({
  ...
  return (
    <div className="h-full w-full xl:flex xl:content-stretch">
      ...
      <div className="relative h-full border-t-2 border-stone-800 bg-stone-50 lg:border-l-2 xl:w-1/2 xl:overflow-scroll xl:border-t-0">
        {parcel ? (
          <div>
          ...
          <article className="flex flex-col space-y-8 p-4">
            <div>
              ...
              <div className="prose prose-lg">
                <p>
                  The <strong>Parcels N&apos;at Data Explorer</strong> provides
                  a user-friendly, realtime view of data about parcels across
                  Allegheny County.
                </p>
                <p></p>
                <p>
            ...
            <div className="prose prose-lg mt-12">
              ...
              <p>
                Aggregate statistics in the <a href="/explore">Explorer</a> and{" "}
                <a href="/indicators">Indicators</a> views use our{" "}
                <a
