...
export const parcelDataSchema: Schema = {
  "recent-sale": {
    label: "Parcel sale in past...",
    items: [
      { id: "", label: "---" },
  ...
  "recent-code-violation": {
    label: "Code violation in past...",
    items: [
      { id: "", label: "---" },
...
export const projectDataSchema: Schema = {
  "risk-level": {
...
export const initValues: Record<string, string | null> = {
  "recent-sale": null,
  "recent-foreclosure": null,
  "recent-code-violation": null,
  "risk-level": null,
